...
namespace KrbRelayUp.Ndr {
    ...
    internal class _Marshal_Helper : KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer {
    ...
    internal class _Unmarshal_Helper : KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer {
    ...
    public struct _PAC_DEVICE_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
        ...
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
        ...
        int KrbRelayUp.Ndr.Marshal.INdrStructure.GetAlignment() {
            return 4;
        }
        public int UserId;
        public int PrimaryGroupId;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> AccountDomainId;
        public int AccountGroupCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> AccountGroupIds;
        public int SidCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_KERB_SID_AND_ATTRIBUTES[]> ExtraSids;
        public int DomainGroupCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<DOMAIN_GROUP_MEMBERSHIP[]> DomainGroup;
    ...
    public struct _RPC_SID : KrbRelayUp.Ndr.Marshal.INdrConformantStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_22(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(SubAuthority, "SubAuthority"), SubAuthorityCount);
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
        ...
        int KrbRelayUp.Ndr.Marshal.INdrConformantStructure.GetConformantDimensions() {
            return 1;
        }
        int KrbRelayUp.Ndr.Marshal.INdrStructure.GetAlignment() {
            return 4;
    ...
    public struct _RPC_SID_IDENTIFIER_AUTHORITY : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_23(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(Value, "Value"));
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _FILETIME : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _GROUP_MEMBERSHIP : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _KERB_SID_AND_ATTRIBUTES : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> Sid;
        public int Attributes;
    ...
    public struct DOMAIN_GROUP_MEMBERSHIP : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> DomainId;
        public int GroupCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> GroupIds;
    ...
    public struct _PAC_DEVICE_CLAIMS_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_CLAIMS_SET_METADATA> Claims;
    ...
    public struct _CLAIMS_SET_METADATA : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<byte[]> ClaimsSet;
        public KrbRelayUp.Ndr.Marshal.NdrEnum16 usCompressionFormat;
        public int ulUncompressedClaimsSetSize;
        public short usReservedType;
        public int ulReservedFieldSize;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<byte[]> ReservedField;
        public static _CLAIMS_SET_METADATA CreateDefault() {
            return new _CLAIMS_SET_METADATA();
        }
        public _CLAIMS_SET_METADATA(int ulClaimsSetSize, byte[] ClaimsSet, KrbRelayUp.Ndr.Marshal.NdrEnum16 usCompressionFormat, int ulUncompressedClaimsSetSize, short usReservedType, int ulReservedFieldSize, byte[] ReservedField) {
    ...
    public struct _UPN_DNS_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _KERB_VALIDATION_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_28(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(Reserved1, "Reserved1"));
            m.WriteInt32(UserAccountControl);
            m.Write_29(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(Reserved3, "Reserved3"));
            m.WriteInt32(SidCount);
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> LogonDomainId;
        public int[] Reserved1;
        public int UserAccountControl;
        public int[] Reserved3;
        public int SidCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_KERB_SID_AND_ATTRIBUTES[]> ExtraSids;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_SID> ResourceGroupDomainSid;
        public int ResourceGroupCount;
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_GROUP_MEMBERSHIP[]> ResourceGroupIds;
    ...
    public struct _RPC_UNICODE_STRING : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<char[]> Buffer;
    ...
    public struct _USER_SESSION_KEY : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_33(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(data, "data"));
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _CYPHER_BLOCK : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.Write_34(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(data, "data"));
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _PAC_INFO_BUFFER : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
    ...
    public struct _NTLM_SUPPLEMENTAL_CREDENTIAL : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.WriteInt32(Flags);
            m.Write_35(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(LmPassword, "LmPassword"));
            m.Write_35(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(NtPassword, "NtPassword"));
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _PAC_CLIENT_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            ...
            m.Write_36(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(Name, "Name"));
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _S4U_DELEGATION_INFO : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<_RPC_UNICODE_STRING[]> S4UTransitedServices;
    ...
    public struct _PAC_CREDENTIAL_DATA : KrbRelayUp.Ndr.Marshal.INdrConformantStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
            m.WriteInt32(CredentialCount);
            m.Write_38(KrbRelayUp.Win32.Rpc.RpcUtils.CheckNull(Credentials, "Credentials"), CredentialCount);
        }
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Unmarshal(KrbRelayUp.Ndr.Marshal.NdrUnmarshalBuffer u) {
            Unmarshal(((_Unmarshal_Helper)(u)));
        }
    ...
    public struct _SECPKG_SUPPLEMENTAL_CRED : KrbRelayUp.Ndr.Marshal.INdrStructure {
        void KrbRelayUp.Ndr.Marshal.INdrStructure.Marshal(KrbRelayUp.Ndr.Marshal.NdrMarshalBuffer m) {
            Marshal(((_Marshal_Helper)(m)));
        }
        private void Marshal(_Marshal_Helper m) {
        ...
        public KrbRelayUp.Ndr.Marshal.NdrEmbeddedPointer<sbyte[]> Credentials;
